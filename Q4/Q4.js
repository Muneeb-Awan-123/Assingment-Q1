...
var author = 'Hazrat Muhammad (peace be upon him)';
//console.log(`${author}  said: "prayer is the cooling of my eyes" `);
//question 5
...
var message = 'prayer is the cooling of my eyes';
console.log("".concat(author, " said: \"").concat(message, "\""));
